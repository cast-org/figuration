...
- [Download the latest release.](https://github.com/cast-org/figuration/archive/v3.0.0-alpha.3.zip)
- Clone the repo: `git clone https://github.com/cast-org/figuration.git`
- Install with [npm](https://www.npmjs.com): `npm install figuration@3.0.0-alpha.3`
- Install with [yarn](https://yarnpkg.com/): `yarn add figuration@3.0.0-alpha.3`
