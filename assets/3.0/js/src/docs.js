...
(function($) {
    ...
    var addClipboard = function() {
        ...
        $('pre[class*="language-"]').each(function() {
            var btnHtml = '<div class="cf-clipboard"><button type="button" class="btn btn-xsmall btn-secondary btn-clipboard print-hide" title="Copy to clipboard">Copy</button></div>';
            $(this).before(btnHtml);
        });
