 ...
 */
function(){"use strict";var e,t=window.navigator.userAgent;-1<t.indexOf("Opera")||-1<t.indexOf("Presto")||null!==(t=function(){var e=/MSIE ([0-9.]+)/.exec(window.navigator.userAgent);if(null===e)return null;e=parseInt(e[1],10);return Math.floor(e)}())&&t!==(e=void 0===(e=new Function("/*@cc_on return @_jscript_version; @*/")())?11:e<9?8:e)&&window.alert("WARNING: You appear to be using IE"+e+" in IE"+t+" emulation mode.\nIE emulation modes can behave significantly differently from ACTUAL older versions of IE.\nPLEASE DON'T FILE CAST FIGURATION BUGS based on testing in IE emulation modes!")}(),function(o){"use strict";Holder.addTheme("gray",{bg:"#999",fg:"#111",size:12,font:"sans-serif",fontweight:"normal"});function r(e){return/^#[0-9A-F]{6}$/i.test(e)?e:"#"+t((e=e.match(/^rgb\((\d+),\s*(\d+),\s*(\d+)\)$/))[1])+t(e[2])+t(e[3]);function t(e){return("0"+parseInt(e,10).toString(16)).slice(-2)}}function i(){function t(e,t){var e=o("#"+e),n=0<=(r=e.attr("href")).indexOf(".min.css"),r=r.replace(/^(.*\/)?[^/]+\.(css)$/i,"$1"+t);e.attr("href",r+=n?".min.css":".css")}function n(e){o("#dir-ltr").closest("ul").find(".active").removeClass("active").removeAttr("aria-current"),o("#dir-ltr").addClass("active").attr("aria-current","true"),o("html").attr("dir","ltr"),e&&(t("cssCore","figuration"),t("cssDocs","docs")),document.cookie="docsDir=;path=/;"}function r(){o("#dir-rtl").closest("ul").find(".active").removeClass("active").removeAttr("aria-current"),o("#dir-rtl").addClass("active").attr("aria-current","true"),o("html").attr("dir","rtl"),t("cssCore","figuration-rtl"),t("cssDocs","docs-rtl"),document.cookie="docsDir=rtl;path=/;"}o("#dir-ltr").on("click",function(e){e.preventDefault(),n(!0)}),o("#dir-rtl").on("click",function(e){e.preventDefault(),r()}),"rtl"===function(e){for(var t=e+"=",n=decodeURIComponent(document.cookie).split(";"),r=0;r<n.length;r++){for(var o=n[r];" "===o.charAt(0);)o=o.substring(1);if(0===o.indexOf(t))return o.substring(t.length,o.length)}return""}("docsDir")?r():n(!1)}o(document,'[data-cfw="player"]').on("ready.cfw.player",function(e){o(e.target).closest('[data-cfw="player"]').find(".dropdown-menu").addClass("dropup dropreverse")}),o(window).ready(function(){var e,t,n;o('pre[class*="language-"]').each(function(){o(this).before('<div class="cf-clipboard"><button type="button" class="btn btn-xsmall btn-secondary btn-clipboard print-none" title="Copy to clipboard">Copy</button></div>')}),o(".btn-clipboard").CFW_Tooltip(),(n=new ClipboardJS(".btn-clipboard",{target:function(e){return e.parentNode.nextElementSibling}})).on("success",function(e){var t=o(e.trigger);t.one("afterHide.cfw.tooltip",t,function(){o(document).one("afterUnlink.cfw.tooltip",t,function(){t.removeAttr("data-cfw-tooltip-title").CFW_Tooltip({title:"Copy to clipboard"})}),t.CFW_Tooltip("dispose")}),t.data("cfw.tooltip").$target.find(".tooltip-body").text("Copied!"),setTimeout(function(){t.CFW_Tooltip("locateUpdate")}),e.clearSelection()}),n.on("error",function(e){var t="Press "+(/Mac/i.test(navigator.userAgent)?"⌘":"Ctrl-")+"C to copy",n=o(e.trigger);o(document).one("afterUnlink.cfw.tooltip",n,function(){o(document).one("afterUnlink.cfw.tooltip",n,function(){n.removeAttr("data-cfw-tooltip-original-title").CFW_Tooltip({title:"Copy to clipboard"})}),n.removeAttr("data-cfw-tooltip-original-title").CFW_Tooltip({title:t,dispose:!0}).CFW_Tooltip("show")}),n.CFW_Tooltip("dispose")}),o(".toplink").CFW_Affix({top:function(){return o(".cf-title").offset().top},bottom:function(){return o("footer").outerHeight()}}),o(window).scroll(),n=o(".palette-base, .palette-item"),t=null,0<n.length&&n.each(function(){t=o(this),e=r(t.css("background-color")),t.append('<span class="float-end">'+e+"</span>")}),(n=o(".cf-toc").eq(0)).length&&(n.attr("aria-label","Page"),o("body").CFW_Scrollspy({offset:75,target:".cf-toc ol"})),i(),o('.cf-example-indeterminate [type="checkbox"]').prop("indeterminate",!0),o('.cf-content [href="#"]').on("click",function(e){e.preventDefault()}),o("#animToggle").on("click",function(){o("#animTarget").toggleClass("progress-bar-animated")})})}(jQuery);