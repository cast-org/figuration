...
The [issue tracker](https://github.com/cast-org/figuration/issues) is
...
0. **Validate your code** &mdash; [validate your HTML](https://html5.validator.nu/)
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork,
   ...
   git clone https://github.com/<your-username>/figuration.git
   # Navigate to the newly cloned directory
   cd figuration
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/cast-org/figuration.git
   ```
...
- When feasible, default color palettes should comply with [WCAG color contrast guidelines](https://www.w3.org/TR/WCAG/#contrast-minimum).
...
By contributing to the documentation, you agree to license your contribution under the [Creative Commons Attribution 4.0 International License](docs/LICENSE).