  ...
  <div class="row mt-2" data-cfw="equalize" data-cfw-equalize-target=".card-footer">
    ...
    <div class="col-sm-6">
      <div class="card card-download">
        ...
        <div class="card-body">
            Download everything: source Sass, JavaScript, and documentation files. <strong>Requires a Sass compiler, <a href="https://github.com/postcss/autoprefixer">Autoprefixer</a>, <a href="https://github.com/luisrudge/postcss-flexbugs-fixes">postcss-flexbugs-fixes</a>, and <a href="{{ site.baseurl }}/{{ site.docs_version }}/get-started/build-tools/#tooling-setup">some setup</a>.</strong>
        </div>
        <div class="card-footer text-sm-center">
