 ...
 */
Holder.addTheme("gray",{bg:"#999",fg:"#111",size:12,font:"sans-serif",fontweight:"normal"}),$(document,'[data-cfw="player"]').on("ready.cfw.player",function(a){$(a.target).closest('[data-cfw="player"]').find(".player-caption-wrapper").addClass("dropup dropdown-menu-left"),$(a.target).closest('[data-cfw="player"]').find(".player-script-wrapper").addClass("dropup dropdown-menu-left")}),$(window).ready(function(){addAnchors(),addClipboard(),topLinkAffix(),paletteHex(),$('.cf-example-indeterminate [type="checkbox"]').prop("indeterminate",!0),$('.cf-content [href="#"]').click(function(a){a.preventDefault()})});